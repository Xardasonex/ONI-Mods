...
{
    [HarmonyPatch(typeof(OilFloaterConfig), "CreatePrefab")]
    ...
    [HarmonyPatch(typeof(OilFloaterDecorConfig), "CreatePrefab")]
    ...
    [HarmonyPatch(typeof(OilFloaterHighTempConfig), "CreatePrefab")]
